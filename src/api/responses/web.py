...
async def generate_web_response(context: ResponseContext) -> list[str]:
    """
    Generate an AI response for web channel messages.

    This handler preserves the current behavior for web-based chat,
    ...
    try:
        ...
        # Store and deliver each message
        await store_and_deliver_response(
            context,
