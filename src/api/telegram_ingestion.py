"""
Telegram webhook router for handling incoming messages from Telegram.

This module provides endpoints for:
- Telegram webhook updates at POST /api/webhooks/telegram
- Callback query handling
- Message and contact handling
- Telegram account linking and onboarding entry point
"""
